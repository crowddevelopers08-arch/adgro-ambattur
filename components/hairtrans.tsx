        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            {combinedImages.map((item, index) => (
              ...
              >
                ...
                <div className="relative h-64 lg:h-72 overflow-hidden rounded-t-lg">
          ...
          <div className="md:hidden relative mb-8">
            ...
            >
              ...
              <motion.button
                ...
                whileTap="tap"
                onClick={prevSlide}
                className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/90 text-[#65302f] w-10 h-16 flex items-center justify-center rounded-l-md shadow-lg"
              ...
              <motion.button
                ...
                whileTap="tap"
                onClick={nextSlide}
                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/90 text-[#65302f] w-10 h-16 flex items-center justify-center rounded-r-md shadow-lg"
          ...
          >
            ...
            <motion.button
              ...
              className="bg-[#65302f] text-white px-8 sm:px-10 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-medium hover:bg-[#e0c9c2] hover:text-[#65302f] transition duration-300 rounded relative overflow-hidden"
            >
              <motion.span
                initial={{ x: "-100%" }}
                whileHover={{ x: "100%" }}
