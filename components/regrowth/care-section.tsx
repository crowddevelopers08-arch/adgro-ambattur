...
const cards = [
  {
    ...
    description:
      "Restore confidence with advanced hairline restoration treatments for receding hairline and forehead correction.",
  },
  {
    icon: "/icon-img-2.png",
    title: "Laser Hair Restoration",
    description:
      "Non-surgical laser hair restoration treatments that help improve blood circulation and support healthier hair growth.",
  },
  {
    icon: "/icon-img-3.png",
    title: "Medical Hair Restoration Clinic",
    description:
      "Our medical hair restoration clinic combines expert diagnosis with advanced therapies for effective hair regrowth.",
  },
  {
    icon: "/icon-img-4.png",
    title: "Hair Restoration for Men & Women",
    description:
      "Customized hair restoration solutions for both men and women experiencing different stages of hair loss.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14 max-sm:mb-6">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[46px] font-extrabold text-[#1f2430] leading-tight mb-4">
            Hair Restoration{" "}
              <span className="text-[#e82625]">Treatments We Offer</span>
          </h2>
          <p className="text-[#6b7280] text-[0.97rem] max-w-lg mx-auto leading-relaxed">
            Advanced Grohair provides comprehensive hair restoration treatments
            for men and women, combining expert care with proven medical therapies.
          </p>
        </div>
