...
const problems = [
  {
    ...
    description:
      "Scientifically designed hair regrowth treatments to reduce hair fall and promote healthier hair growth.",
    icon: "/icon-img-5.png",
  },
  {
    title: "Hair Treatment for Regrowth",
    description:
      "Customized therapies focused on improving scalp health, strengthening roots, and restoring hair density.",
    icon: "/icon-img-4.png",
  },
  {
    title: "Advanced Hair Regrowth Treatment",
    description:
      "Modern non-surgical solutions for hair loss and hair regrowth with visible improvements over time.",
    icon: "/icon-img-3.png",
  },
  {
    title: "Laser Hair Regrowth Therapy",
    description:
      "Safe and effective laser treatment for hair regrowth designed for both men and women.",
    icon: "/icon-img-1.png",
  },
  {
    title: "Hair Loss and Hair Regrowth Treatment",
    description:
      "Comprehensive solutions targeting hair thinning, scalp weakness, and poor hair growth cycles.",
    icon: "/icon-img-2.png",
  },
];
...
export default function HairProblems() {
  ...
  return (
    <section className="py-16 max-sm:py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 max-sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#1f2430] leading-tight">
            ...
            <span className="text-[#e82625]">We Offer</span>
          </h2>
