...
const faqs = [
  {
    ...
    answer:
      "The best treatment for hair regrowth depends on your scalp condition, hair fall severity, and hair growth cycle. Our specialists recommend personalized solutions after consultation.",
  },
  {
    question: "Do you provide hair regrowth treatment for men?",
    answer:
      "Yes, we offer advanced hair regrowth for men experiencing hair thinning, receding hairline, and male pattern baldness.",
  },
  {
    question: "Is hair regrowth treatment available for women?",
    answer:
      "Yes, we provide hair regrowth for women dealing with hormonal hair fall, postpartum hair loss, and thinning hair.",
  },
  {
    question: "How does laser treatment for hair regrowth work?",
    answer:
      "Laser treatment improves scalp blood circulation and stimulates follicles to support healthier hair growth.",
  },
  {
    question: "How long does hair regrowth treatment take?",
    answer:
      "Results vary depending on the condition, but most patients notice gradual improvements over several weeks to months.",
  },
  {
    question: "Is Advanced Grohair a hair regrowth clinic near me?",
    answer:
      "Yes, Advanced Grohair is one of the trusted hair regrowth clinics in Chennai offering advanced hair restoration solutions.",
  },
];
