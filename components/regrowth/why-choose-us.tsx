...
const features = [
  {
    step: "01",
    title: "Best Hair Regrowth Specialists",
    description:
      "Our experienced professionals analyze your scalp condition and recommend the best treatment for hair fall and regrowth based on your hair type and hair loss stage.",
    icon: (
  ...
  },
  {
    ...
    description:
      "We use modern hair regrowth therapies designed to stimulate dormant follicles and improve natural hair density.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  {
    step: "03",
    title: "Hair Loss and Hair Regrowth Solutions",
    description:
      "Our treatments target the root cause of hair loss and hair regrowth problems including stress, genetics, hormonal imbalance, and scalp conditions.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  {
    step: "04",
    title: "Hair Regrowth for Men",
    description:
      "Our men's hair regrowth treatments are ideal for male pattern baldness, thinning crown, and receding hairline concerns.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  {
    step: "05",
    title: "Hair Regrowth for Women",
    description:
      "We provide personalized hair regrowth for women experiencing postpartum hair fall, hormonal hair loss, thinning hair, and widening partition.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  {
    step: "06",
    title: "Laser Treatment for Hair Regrowth",
    description:
      "Advanced laser treatment for hair regrowth helps improve scalp circulation and support stronger hair growth naturally.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
...
export default function WhyChooseUs() {
  ...
  return (
    <section className="py-16 max-sm:py-4 px-4 sm:px-6 lg:px-8 bg-[#fff7f7]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 max-sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#1f2430] leading-tight max-w-2xl mx-auto">
            ...
            <span className="text-[#e82625]">Hair Regrowth</span> Clinic?
          </h2>
