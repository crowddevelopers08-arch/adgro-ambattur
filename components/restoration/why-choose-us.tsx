...
const features = [
  {
    ...
    description:
      "Our certified hair restoration surgeons use advanced diagnostic methods and personalized treatments to restore healthy hair growth naturally.",
    icon: (
  ...
  },
  {
    ...
    description:
      "We offer modern hair restoration treatments designed for hair thinning, bald spots, weak roots, and receding hairline conditions.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  },
  {
    ...
    description:
      "No generic solutions. Every hair restoration treatment is customized based on scalp condition, hair density, and hair loss stage.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  },
  {
    ...
    description:
      "Our men's hair restoration treatments target male pattern baldness, crown thinning, temple recession, and hairline restoration.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  },
  {
    ...
    description:
      "We provide women's hair restoration treatments for hair thinning, widening partition, postpartum hair loss, and hormonal hair fall.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
  ...
  },
  {
    ...
    description:
      "Achieve natural hairline restoration with advanced techniques focused on density, symmetry, and natural appearance.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 max-sm:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-[#1f2430] leading-tight max-w-2xl mx-auto">
            ...
            <span className="text-[#e82625]">Hair Restoration</span> Center?
          </h2>
